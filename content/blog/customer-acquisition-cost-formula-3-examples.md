...
differentiator: >-
  ...
  **omnicalculator.com** y **zendesk.com**. Los tres explican la misma fórmula
  (gasto total ÷ clientes nuevos), usan ejemplos con empresas genéricas de
  tamaño mediano y recomiendan el ratio LTV:CAC de 3:1 — pero ninguno define qué
  costos van exactamente en el numerador, y ninguno publica benchmarks reales
  por industria con fuente primaria citada.


  La contradicción que dejan abierta: dicen "suma todos los gastos de marketing
  y ventas" sin aclarar si eso incluye suscripciones a herramientas, tiempo del
  equipo o comisiones de afiliados. Resultado: el dueño de PYME cuenta solo su
  gasto en ads, compara un número incompleto contra un benchmark que no aparece
  en ninguno de esos artículos, y no sabe si está bien o mal.


  Este artículo resuelve eso con tres cosas que los tres primeros no tienen: (1)
  una tabla de categorías de costo que define exactamente qué entra en el
  numerador, (2) tres ejemplos trabajados con desglose línea por línea y precios
  de herramientas reales, y (3) una tabla de benchmarks verificados directamente
  del dataset de First Page Sage (2020–2025) — fuente primaria que ninguno de
  los tres artículos actuales cita.


  *Nota técnica SEO:* El título tiene 48 caracteres. Con el sufijo " -
  faststrat.ai" el meta title llegaría a 64, por encima del corte de Google
  (60). Recomiendo usar un meta title separado: "How to Calculate Customer
  Acquisition Cost" (43 chars) y conservar el H1 actual. Meta description
...
| [Apollo.io Basic plan](https://www.apollo.io/pricing) ($49/month, annual billing) | $147 |
| Total | $2,397 |

New paid signups: 7
**CAC: $2,397 ÷ 7 = $342**

First Page Sage's 2025 dataset puts the [average B2B SaaS CAC at $239](https://firstpagesage.com/reports/average-customer-acquisition-cost-cac-by-industry-b2b-edition-fc/), $103 below this team's number. The likely culprit is channel mix: organic-channel B2B SaaS CAC in the same dataset averages $205, while paid-channel CAC averages $341 ([First Page Sage](https://firstpagesage.com/reports/average-customer-acquisition-cost-cac-by-industry-b2b-edition-fc/)). This team is spending almost entirely on paid, which puts it exactly at the paid-channel ceiling. Shifting more budget toward content, which they're already doing at a small scale, typically pulls the blended number down over two to three quarters.
...
The benchmark for IT and Managed Services is $454 ([First Page Sage 2025](https://firstpagesage.com/reports/average-customer-acquisition-cost-cac-by-industry-b2b-edition-fc/)). The gap isn't the ads, it's the owner's time. At $2,625 for the quarter, business development labor is the single largest line item, and it's invisible in the simple CAC calculation. A firm that only tracks its LinkedIn spend would show a CAC of $529 (($2,000 + $147 + $500) ÷ 5), which looks close to benchmark, but isn't the real number. The corrected figure signals one of two actions: raise prices to improve LTV, or convert a higher percentage of outreach conversations so the same time cost generates more clients.

## CAC benchmarks by industry

These figures come from First Page Sage's [ecommerce report](https://firstpagesage.com/reports/average-cac-for-ecommerce-companies/) and [B2B report](https://firstpagesage.com/reports/average-customer-acquisition-cost-cac-by-industry-b2b-edition-fc/), based on data from 80+ ecommerce and 100+ B2B clients collected between 2020 and 2025. They represent blended averages across organic and paid channels.
...
In almost every B2B industry, organic-channel CAC runs materially below paid-channel CAC. In B2B SaaS specifically, the gap is $205 (organic) vs. $341 (paid). In construction, $212 vs. $486 ([First Page Sage B2B report](https://firstpagesage.com/reports/average-customer-acquisition-cost-cac-by-industry-b2b-edition-fc/)). Organic takes longer to build, but the unit economics tend to be significantly better once the channel matures.
...
For SaaS companies, the median payback period is [16 months according to 2025 benchmarks from Aleph × Benchmarkit](https://www.getaleph.com/answers/cac-payback-period-saas-2026) (342 companies). For small businesses with lower-ACV products (under $15,000/year), a payback period of 8–12 months is both achievable and the healthy target range. Under 12 months marks top-tier efficiency.
...
[FastStrat's marketing analytics agents](https://faststrat.ai/marketing-analytics) track CAC by channel automatically, so you don't have to pull data manually each quarter.
